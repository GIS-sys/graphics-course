...
void WorldRenderer::loadShaders()
{
  etna::create_program(
    "simple_material",
    {PARTICLES_SHADERS_ROOT "simple_shadow.frag.spv", PARTICLES_SHADERS_ROOT "simple.vert.spv"});
  etna::create_program("simple_shadow", {PARTICLES_SHADERS_ROOT "simple.vert.spv"});
}
